                ...
                <div class="col-lg-12 text-center">
                    <asp:GridView ID="TraineeList" runat="server" CssClass="table table-bordered text-left"
                        ...
                        <Columns>
                            ...
                            <asp:HyperLinkField Text="Assign" DataNavigateUrlFields="TraineeID"
                                DataNavigateUrlFormatString="~/AssignWorkout.aspx?TraineeID={0}" ControlStyle-CssClass="btn btn-xs btn-default"
                                ItemStyle-CssClass="text-center" />
                            <asp:HyperLinkField Text="View Workout" DataNavigateUrlFields="TraineeID"
                                DataNavigateUrlFormatString="~/ViewWorkout.aspx?TraineeID={0}" ControlStyle-CssClass="btn btn-xs btn-success"
                                ItemStyle-CssClass="text-center"/>
                        </Columns>
                    </asp:GridView>
                </div>
